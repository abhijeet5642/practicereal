...
export default function PropertyManagement() {
  ...
  const handleAddProperty = async (formData) => {
    // This implementation assumes the backend is set up to handle multipart/form-data,
    // which is necessary for file uploads. It also assumes arrays (like amenities)
    // are sent as JSON strings.
    try {
